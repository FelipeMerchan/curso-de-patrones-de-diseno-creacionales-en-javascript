...
class MastodonSedanCar extends BaseCar {
  ...
  constructor(carToClone) {
    /* El constructor recibe la versión a clonar y llama al super para llamar al método constructor de la clase
    de la que hereda. Así la información que tiene el coche en ese momento va a pasar al nuevo objeto clonado: */
    super({
   ...
   */
  clone() {
    /* this es la instancia que va a llamar el método clone, la configuración de la instancia
    que llama el método clone va a ser llamada aquí como parámetro */
